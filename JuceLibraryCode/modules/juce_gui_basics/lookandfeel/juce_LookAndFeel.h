...
public:
    ...
    */
    ...
    /** Make a top level window float on top of other windows in the same app, but not system windows or other apps.*/
    static void makeWindowFloatingPanel(Component *aComponent);
private:
    //==============================================================================
